...
class BottomNavigationViewHelper {
    ...
    companion object{
        fun setupBottomNavigationView(btNavigation:BottomNavigationViewEx){
            btNavigation.enableAnimation(false)
            btNavigation.enableItemShiftingMode(false)
            btNavigation.enableShiftingMode(false)
            btNavigation.setTextVisibility(false)
        }
